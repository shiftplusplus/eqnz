...
For the same period as the New Zealand Data (from September 2011 to September 2016), in earthquakes data from the United Istituto Nazionale di Geofisica e Vulcanologia there are `r eq_total` events of depth greater than 0 and magnitude greater than 0.
...
```{r, fig.cap="Proportion of earthquakes at night: Italy. n=103093"}
...
```{r, fig.cap="Proportion of night earthquakes by magnitude, Italy. n=103093"}
old_par=par()
...
```{r, fig.cap="Over- and under- supply of earthquakes by angle of the sun (10 degree steps). Italy. n=103093"}
norm_ci$border = 2
