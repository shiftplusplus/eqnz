...
Earthquakes data from the United States Geological Service there are `r eq_total` events of depth greater than 0 and magnitude greater than 0.
...
```{r, fig.cap="Proportion of night earthquakes by magnitude, Hawaii. n=10181"}
old_par=par()
...
```{r, fig.cap="Over- and under- supply of earthquakes by angle of the sun (10 degree steps). Hawaii. n=10181"}
norm_ci$border = 2
