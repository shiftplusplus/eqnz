...
```{r, fig.cap="Proportion of earthquakes occurring at night by magnitude (0.5 steps)"}
old_par=par()
...
By discarding all events outside that distance as potentially unable to be detected in the day, of the `r detectable$total` events that remained, `r detectable$at_night` occurred at night. From that we can strongly reject (5 Sigma confidence interval of the proportion is `r round(bt$conf.int[1],3)` to `r round(bt$conf.int[2],3)`) the hypothesis that equal numbers of earthquakes occur in the day and at night among earthquakes at a range that can be detected in the day.
