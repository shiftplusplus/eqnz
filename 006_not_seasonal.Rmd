...
```{r, fig.cap="Proportion of night earthquakes by length of night. n = 100279"}
...
plot(x=c(min(grf$hour_band),max(grf$hour_band)+1), y=c(0,1), type="n", bty="n", 
     xlab="Hours of night", ylab="Proportion of earthquakes at night")
